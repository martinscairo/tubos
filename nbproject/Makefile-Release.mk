...
${OBJECTDIR}/Lib/Geometria.o: Lib/Geometria.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Lib/Geometria.o Lib/Geometria.cpp

${OBJECTDIR}/Lib/Ponto2D.o: Lib/Ponto2D.cpp 
	${MKDIR} -p ${OBJECTDIR}/Lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Lib/Ponto2D.o Lib/Ponto2D.cpp

${OBJECTDIR}/Lib/Tubo.o: Lib/Tubo.cpp 
	${MKDIR} -p ${OBJECTDIR}/Lib
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Lib/Tubo.o Lib/Tubo.cpp
